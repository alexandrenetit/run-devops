...
| Image | Status |
| ------------- | ------------- |
| Shopping Client |  [![Build Status](https://dev.azure.com/alexandredevaz/shopping/_apis/build/status/shoppingclient-pipeline?branchName=main)](https://dev.azure.com/alexandredevaz/shopping/_build/latest?definitionId=9&branchName=main) |
| Shopping API |  [![Build Status](https://dev.azure.com/alexandredevaz/shopping/_apis/build/status/shoppingapi-pipeline?branchName=main)](https://dev.azure.com/alexandredevaz/shopping/_build/latest?definitionId=8&branchName=main) | | |
